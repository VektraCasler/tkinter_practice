# data_entry_app.py
''' Alan D. Moore's ABQ Data Entry Application - Class rewrite version. '''
...
class LabelInput(tk.Frame):
    '''A widget contaiing a label and input together.'''
    def __init__(self, parent, label, var, input_class=ttk.Entry, input_args=None, label_args=None, **kwargs):
        ...
        if input_class == ttk.Radiobutton:
            ...
            for v in input_args.pop('values', []):
                ...
                button.pack(
                    side=tk.LEFT, ipadx=10, ipady=2, expand=True, fill='both'
                )
...
class DataRecordForm(ttk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        LabelInput(
            ...
            input_args={"from_": 4, "to": 100, "increment": 0.01}
        ).grid(row=0, column=1)
        LabelInput(
